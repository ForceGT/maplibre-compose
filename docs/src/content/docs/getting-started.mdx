...
Add the MapLibre Native framework with Kotlin's
[SwiftPM import][gradle-spm]:
...
The [setup guide][gradle-spm] covers the Kotlin Gradle plugin version and the
first-time Xcode linkage step.
...
[gradle-spm]: https://kotlinlang.org/docs/multiplatform/multiplatform-spm-import.html
