 ...
 *
 * Feature-state mutation is available on desktop, Android, and the browser. iOS throws: the
 * MapLibre iOS SDK keeps that API on the map view, which this source has no path to.
 */
